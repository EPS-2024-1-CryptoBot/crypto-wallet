...
class Blockchain:
    ...
    def __init__(self):  # "self" usa as variáveis do objeto
        ...
        # cria uma lista para as transações: as transações são adicionadas ao
        # bloco através da mineração
        self.transactions = []
        # cria o bloco gênesis
        self.create_block(proof=1, previous_hash="0")
        # adiciona os nós participantes da rede através de um set (mais
        # otimizado q o list)
        self.nodes = set()

    # função que cria um bloco com suporte a transações e adiciona ao
    # blockchain (encadear)
    ...
    # função que faz o proof-of-work (deve ser difícil de resolver e fácil de
    # recuperar)
    def proof_of_work(
        self, previous_proof
        ...
        # resolve o hash (quanto mais zeros à esquerda, mais difícil o
        # problema)
    ...
    def is_chain_valid(
        ...
        while block_index < len(chain):  # percorre todos os blocos do blockchain
            ...
            # verifica se o hash do bloco atual (dicionário) é igual ao hash do
            # bloco anterior
            ...
            block_index += 1
        # se deu tudo certo com as 2 validações (proof-of-work e o hash
        # anterior), retorna True
        return True
    ...
    # função do protocolo de consenso (substitui o blockchain se encontrar um
    # bloco maior)
...
def add_transaction():  # cria a transação
    ...
    if not all(key in json for key in transaction_keys):
        ...
        # retorna a mensagem no formato json e o status de resposta http
        # (Created)
